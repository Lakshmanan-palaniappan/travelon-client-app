...
// import 'package:Travelon/core/utils/apppcolors.dart';
...
//               children: [
//                 _progressBar(),
//                 Expanded(child: Form(key: _formKey, child: _stepContent())),
...
//             value: selectedDevice == DeviceType.device,
//             onChanged: (value) {
//               if (value == true) {
//                 setState(() {
...
//             value: selectedDevice == DeviceType.mobile,
//             onChanged: (value) {
//               if (value == true) {
//                 setState(() {
...
//   //     selectedType: selectedDevice?.name, // "mobile" or "wearable"
//   //   );
...
//   //             onPressed: () {
//   //               ;
//   //               print("ncodsncosnodcnsc💕💕💕💕💕💕💕💕 $selectedDevice");
//   //               if (isLastStep) {
...
//       case 1:
//         return _secondstepper();
//       case 2:
//         return _thirdstepper();
//       case 3:
//         return _fourthstepper();
//       default:
...
//             child: Myelevatedbutton(
//               radius: 50,
//               show_text: isLastStep ? "Create Account" : "Continue",
//               onPressed: () {
//                 if (isLastStep) {
//                   if (!_formKey.currentState!.validate()) return;

//                   if (selectedKycFile == null) {
//                     showErrorFlash(context, "Please upload KYC document");
//                     return;
//                   }
...
//                     kycType: selectedkycType,
//                     selectedType:
//                         selectedDevice?.name, // "mobile" or "wearable"
//                   );
...
//                   );
//                 } else {
//                   _onContinue(); // ✅ manual step change
//                 }
//               },
//             ),
//           ),
